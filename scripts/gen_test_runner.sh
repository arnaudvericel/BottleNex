...
cxxtestgen --xunit-printer -w BottleNex --have-eh -o $TEST_DIR/$RUNNER_CPP $TEST_DIR/test_road.h $TEST_DIR/test_config.h $TEST_DIR/test_vehicle_factory.h $TEST_DIR/test_lane.h $TEST_DIR/test_writer.h $TEST_DIR/test_car.h
